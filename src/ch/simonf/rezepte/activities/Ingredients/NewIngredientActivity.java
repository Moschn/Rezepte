...
import ch.simonf.rezepte.R.id;
import ch.simonf.rezepte.R.layout;
...
public class NewIngredientActivity extends Activity {
	...
	private static String url_create_product = "http://lv-studios.ch/projects/android_connect/create_product.php";
	...
	class CreateNewProduct extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(NewIngredientActivity.this);
